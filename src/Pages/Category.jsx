...
class Category extends Component {
  ...
  fetchJobs() {
    ...
    if (localStorage.getItem("signed")) {
      ...
      fetch(`https://shielded-sands-39483.herokuapp.com/https://remotive.io/api/remote-jobs?category=${params.category}&limit=150`, {signal})
      .then(response => response.json())
      .then(jobs => { 
          this.setState({...this.state, jobs: jobs})
      })
  ...
  render() {
    ...
    return (
      <div className="App">
        <Helmet>
            <meta charSet="utf-8" />
            <title>Best {params.category.replace(/[-]/g, " ")} remote Jobs - FromHome</title>
        </Helmet>
        <Header draw={draw} />
